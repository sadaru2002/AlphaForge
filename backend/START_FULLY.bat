...
ssh -i %TEMP%\oracle.key ubuntu@161.118.218.33 "sudo docker stop alphaforge-backend alphaforge-scheduler 2>/dev/null"

echo.
echo [2/4] Removing containers...
ssh -i %TEMP%\oracle.key ubuntu@161.118.218.33 "sudo docker rm alphaforge-backend alphaforge-scheduler 2>/dev/null"

echo.
echo [3/4] Starting Backend on network...
...
echo.
echo [4/4] Starting Scheduler on network...
...
echo ================================
echo Backend: http://161.118.218.33
echo Health: http://161.118.218.33/health
echo ================================
