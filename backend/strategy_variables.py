...
# ============================================================================
# 🎯 MODERATE QUALITY MODE: Targeting ~10-12 trades/day
# Uses Volume filter only to maintain quality while keeping reasonable frequency
...
VOLUME_MULTIPLIER = 1.2      # ✅ Need 20% above average volume (moderate filter)

# RSI & EMA Filter
ENABLE_RSI_EMA_FILTER = False  # Disabled - Too strict when combined with others

# EMA 200 Filter  
ENABLE_EMA_FILTER = False    # Disabled - Eliminates too many trades
EMA_LENGTH = 200             # Length of EMA filter

# ADX Filter
ENABLE_ADX_FILTER = False    # Disabled - Too strict
ADX_SMOOTHING = 14
ADX_DI_LENGTH = 14
ADX_THRESHOLD = 25           # Minimum ADX value

# Additional RSI Filter
ENABLE_RSI_FILTER = False    # Disabled

# Bollinger Bands Filter
ENABLE_BB_FILTER = False     # Disabled
